...
message
    ...
    def pump_on(self):
        ...
        self.set_air_pump(self.pump_pwm_values[1]) # 气泵打开 에어펌프 on
    ...
    def pump_off(self):
        ...
        self.set_air_pump(self.pump_pwm_values[0], wait=False) # 气泵关闭 에어펌프 off
        self.set_valve(self.valve_pwm_values[1], wait=False) # 电磁阀打开 밸브 열림
        time.sleep(1)
        self.set_valve(self.valve_pwm_values[0], wait=False) # 电磁阀关闭 밸프 닫힘
